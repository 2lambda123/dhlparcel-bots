...
# Simple kafka connection. Each message becomes a file with filename pattern: <topic>-<partition>-<offset>
# TODO:
#    - Configuration of brokers, topics  
...
class kafka(_comsession):
    ...
    def _init_consumer(self):
        ...
        self.sasl_password = self.channeldict['kafka_sasl_password']
