...
class ChannelAdmin(BotsAdmin):
    ...
    fieldsets = (
        ...
        (_('Kafka specific'), {'fields': ('kafka_topic', 'kafka_brokers', 'kafka_group_id', 'kafka_sasl_username', 'kafka_sasl_password', 'kafka_sasl_mechanisms', 'kafka_security_protocol' ),
                               'classes': ('collapse wide extrapretty',)
                               }),                                            
